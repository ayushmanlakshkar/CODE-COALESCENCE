        ...
        <header className="relative flex items-center justify-center overflow-hidden pt-20">
            ...
            <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
                <div className="inline-block relative">
                    ...
                    <img className='w-32 md:w-40 mix-blend-overlay' src={logo} />
                </div>
                ...
                <p className="text-lg md:text-2xl text-content-muted mb-12 max-w-2xl mx-auto">
                ...
                <div className="flex sm:hidden gap-4 justify-center">
                    ...
                    {/* <button className="px-8 py-4 rounded-xl font-semibold text-lg border border-primary/30 hover:bg-cyan-500/10 transition-all">
              Learn More
            </button> */}
                </div>
